...
#define CXDPlaceTitleColor RGB(79,79,87)
//背景色  淡蓝色        f8fdfd
...
//适配大小
//根据ip6的屏幕来拉伸
#define Scale(with) ((with)*(kScreenWidth/375.0f))
#define ScaleY(height)  (height)*(kScreenHeight/667.0f)
#define Font(R) [UIFont systemFontOfSize:(R)*(kScreenWidth)/375.0f]
